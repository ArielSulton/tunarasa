...
// Policies for other tables (sessions, qa_logs, notes, etc.)
export const sessionsPolicies = sql`
  -- Drop existing policies
  ...
  -- Anyone can manage sessions (anonymous access)
  CREATE POLICY "Anyone can manage sessions" ON public.sessions
    FOR ALL USING (true);
