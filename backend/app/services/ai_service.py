        ...
        try:
            response = self.client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "Anda adalah asisten layanan pemerintah Indonesia yang sangat membantu. Berikan informasi yang jelas dan akurat. WAJIB SELALU jawab dalam bahasa Indonesia yang baik dan benar.",
                    },
...
class AIService:
    ...
    async def summarize_and_generate_title(self, conversation: str) -> Dict[str, str]:
        ...
        try:
            ...
            return {
                "title": "Tidak ada judul yang tersedia",
    ...
    async def process_question(
        self, question: str, session_id: str, context: Optional[Dict[str, Any]] = None
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            if cached_response:
                logger.info(
                    f"Returning cached response for question: {question[:50]}..."
                )
