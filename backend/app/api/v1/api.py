...
from app.api.v1.endpoints import admin, gesture, health, monitoring, rag, summary, faq_clustering
...
api_router.include_router(faq_clustering.router, prefix="/faq_clustering", tags=["faq_clustering"])
